...
return [
    ...
    */
    ...
    'providers' => [
         ...
         */
        ProjetoMK\Providers\AppServiceProvider::class,
        ProjetoMK\Providers\AuthServiceProvider::class,
        // ProjetoMK\Providers\BroadcastServiceProvider::class,
        ProjetoMK\Providers\EventServiceProvider::class,
        ProjetoMK\Providers\RouteServiceProvider::class,
        ProjetoMK\Providers\RepositoryServiceProvider::class,
